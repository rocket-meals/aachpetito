                ...
                <BottomSheetView style={{ ...styles.sheetView, backgroundColor: theme.sheet.sheetBg }}>
                        <View style={styles.sheetHeader}>
                                <Text style={{ ...styles.sheetHeading, color: theme.sheet.text }}>
                                        {translate(TranslationKeys.foodoffers_next_day_time)}
                                </Text>
                        </View>
                        <Text style={{ ...styles.description, color: theme.sheet.text, opacity: 0.75 }}>
                                {translate(TranslationKeys.foodoffers_next_day_time_description)}
                        </Text>
                        <View style={styles.inputContainer}>
                                <TimeInput
                                        id="foodoffers-next-day-threshold"
                                        value={value}
